...
public class LeaderBoardFragment extends Fragment {
    ...
    RecyclerView leaderboardrecycle;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        leaderboardrecycle = view.findViewById(R.id.leaderboardRecycler);
        users = new ArrayList<>();
        LinearLayoutManager layoutManager = new LinearLayoutManager(getContext());
        leaderboardrecycle.setLayoutManager(layoutManager);
        adapter = new LeaderBoardAdapter(requireContext(),users);
        leaderboardrecycle.setAdapter(adapter);
        ...
        Query query = reference.orderByChild("points");
